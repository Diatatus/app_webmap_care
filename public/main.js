...
const styleFunction = function (feature) {
        if (displayProjectType.includes(feature.get('Program')) && projectStatus.includes(feature.get('Status')) && yearList.includes(feature.get('Year'))) {
            var mapExtent = mapView.calculateExtent(map.getSize());
            if (ol.extent.containsCoordinate(mapExtent, feature.getGeometry().getCoordinates())) {
...
function refreshTOCandProjectDetails() {
    if (selectedFeatures.length > 0) {
        ...
        document.getElementById("spanProjectCount").textContent = selectedFeatures.length;
        document.getElementById("varBudgetTracking").textContent = 'Total Budget - $ ' + (totBudget / 1000000).toFixed(2) + ' M';
        document.getElementById("varBudget").textContent = 'Average Budget - $ ' + ((totBudget / 1000000) / selectedFeatures.length).toFixed(2) + ' M';
        ...
        document.getElementById("spanProjectHeading").textContent = selectedFeatures[0].get('Sitename');
        document.getElementById("spanProjectID").textContent = selectedFeatures[0].get('ProjectID');

        document.getElementById("btnBudgetStatus").textContent = 'On Budget';
        if (document.getElementById("btnBudgetStatus").classList.contains('btnRed')) { document.getElementById("btnBudgetStatus").classList.remove('btnRed'); };
        if (document.getElementById("btnBudgetStatus").classList.contains('btnGreen')) { document.getElementById("btnBudgetStatus").classList.remove('btnGreen'); };
        if (document.getElementById("btnBudgetStatus").classList.contains('btnOrange')) { document.getElementById("btnBudgetStatus").classList.remove('btnOrange'); };
        ...
        if (document.getElementById("btnScheduleStatus").classList.contains('btnRed')) { document.getElementById("btnScheduleStatus").classList.remove('btnRed'); };
        if (document.getElementById("btnScheduleStatus").classList.contains('btnGreen')) { document.getElementById("btnScheduleStatus").classList.remove('btnGreen'); };
        if (document.getElementById("btnScheduleStatus").classList.contains('btnOrange')) { document.getElementById("btnScheduleStatus").classList.remove('btnOrange'); };
        document.getElementById("btnScheduleStatus").classList.add('btnRed');

        document.getElementById("spanProjectDescriptionText").textContent = selectedFeatures[0].get('Projectdescription');
        document.getElementById("spanProjectBudgetText").textContent = '$ ' + selectedFeatures[0].get('Budget');
        ...
        document.getElementById("spanProjectManagerText").textContent = selectedFeatures[0].get('Projectmanager');
        document.getElementById("spanProjectResponsibleText").textContent = selectedFeatures[0].get('ResposibleOfficer');
    ...
    for (i = 0; i < selectedFeatures.length; i++) {
        ...
        spanProjectName.setAttribute('onclick', "showProjectDetail('" + selectedFeatures[i].get("ProjectID") + "')");
...
function featureInfoNxt() {
    var currentTableNo = document.getElementById("featureCountSpan").textContent.split('/')[0].trim();

    if (currentTableNo != selectedFeatures.length) {
        document.getElementById("spanProjectHeading").textContent = selectedFeatures[currentTableNo].get('Sitename');
        document.getElementById("spanProjectID").textContent = selectedFeatures[currentTableNo].get('ProjectID');
        ...
        document.getElementById("spanProjectDescriptionText").textContent = selectedFeatures[currentTableNo].get('Projectdescription');
        document.getElementById("spanProjectBudgetText").textContent = '$ ' + selectedFeatures[currentTableNo].get('Budget');
        ...
        if (selectedFeatures[currentTableNo].get('Status') == 'Under Construction') {
            document.getElementById("btnPhaseDesign").className = '';
            document.getElementById("btnPhaseConstruction").className = '';
            document.getElementById("btnPhaseCompleted").className = '';
        ...
        document.getElementById("spanProjectManagerText").textContent = selectedFeatures[currentTableNo].get('Projectmanager');
        document.getElementById("spanProjectResponsibleText").textContent = selectedFeatures[currentTableNo].get('ResposibleOfficer');

        document.getElementById("featureCountSpan").textContent = '  ' + (Number(currentTableNo) + 1) + ' / ' + selectedFeatures.length + '  ';

        cyanSelectionFeatureOverlay.getSource().clear();
        cyanSelectionFeatureOverlay.getSource().addFeature(selectedFeatures[currentTableNo]);
    }
}
...
function featureInfoPre() {
    var currentTableNo = document.getElementById("featureCountSpan").textContent.split('/')[0].trim();
    if (currentTableNo != 1) {
        document.getElementById("spanProjectHeading").textContent = selectedFeatures[currentTableNo - 2].get('Sitename');
        document.getElementById("spanProjectID").textContent = selectedFeatures[currentTableNo - 2].get('ProjectID');
        ...
        document.getElementById("spanProjectDescriptionText").textContent = selectedFeatures[currentTableNo - 2].get('Projectdescription');
        document.getElementById("spanProjectBudgetText").textContent = '$ ' + selectedFeatures[currentTableNo - 2].get('Budget');
        ...
        if (selectedFeatures[currentTableNo - 2].get('Status') == 'Under Construction') {
            document.getElementById("btnPhaseDesign").className = '';
            document.getElementById("btnPhaseConstruction").className = '';
            document.getElementById("btnPhaseCompleted").className = '';
        ...
        document.getElementById("spanProjectManagerText").textContent = selectedFeatures[currentTableNo - 2].get('Projectmanager');
        document.getElementById("spanProjectResponsibleText").textContent = selectedFeatures[currentTableNo - 2].get('ResposibleOfficer');

        document.getElementById("featureCountSpan").textContent = '  ' + (Number(currentTableNo) - 1) + ' / ' + selectedFeatures.length + '  ';

        cyanSelectionFeatureOverlay.getSource().clear();
        cyanSelectionFeatureOverlay.getSource().addFeature(selectedFeatures[currentTableNo - 2]);
    }
}

var yearList = ['FYE2019', 'FYE2020', 'FYE2021', 'FYE2022', 'FYE2023', 'FYE2024'];
function toggleYear(year) {
    selectedFeatures = [];
    selectedFeatureIDs = [];
    if (document.getElementById("btnYear" + year).classList.contains('btnYearBlue')) {
    ...
    } else if (document.getElementById("btnYear" + year).classList.contains('btnYearGrey')) {
...
function showProjectDetail(id) {
    ...
    document.getElementById("spanProjectHeading").textContent = selectedFeatures[featureIndex].get('Sitename');
    document.getElementById("spanProjectID").textContent = selectedFeatures[featureIndex].get('ProjectID');
    ...
    document.getElementById("spanProjectDescriptionText").textContent = selectedFeatures[featureIndex].get('Projectdescription');
    document.getElementById("spanProjectBudgetText").textContent = '$ ' + selectedFeatures[featureIndex].get('Budget');
    ...
    document.getElementById("spanProjectManagerText").textContent = selectedFeatures[featureIndex].get('Projectmanager');
    document.getElementById("spanProjectResponsibleText").textContent = selectedFeatures[featureIndex].get('ResposibleOfficer');

    document.getElementById("featureCountSpan").textContent = '  ' + (Number(featureIndex) + 1) + ' / ' + selectedFeatures.length + '  ';

    cyanSelectionFeatureOverlay.getSource().clear();
    cyanSelectionFeatureOverlay.getSource().addFeature(selectedFeatures[featureIndex]);
}
